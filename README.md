...
The contribution of COROLLA is finding a new modality generated from OCT volumes to achieve better and faster dignosis performance on glaucoma grading task. We use [OCT-Explorer](https://iibi.uiowa.edu/tags/oct-explorer) to get the thickness map. The dataset is available [here](https://gamma.grand-challenge.org/).
